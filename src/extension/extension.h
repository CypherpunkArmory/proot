...
extern int droid_files_callback(Extension *extension, ExtensionEvent event, intptr_t d1, intptr_t d2);
extern int no_orphans_callback(Extension *extension, ExtensionEvent event, intptr_t d1, intptr_t d2);
